...
// Gets options appropriate for any file in `dir`, given that the user's root
// directory is `rootDir` and `options` have already been supplied and should be
// kept in favor of any options found in config files between `dir` and
// `rootDir`. `callback` is invoked with the final set of options.
